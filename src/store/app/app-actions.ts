...
import {APP_NAME, AppDialogType, AppPersist, BackgroundTheme} from './app-model';
...
export namespace AppActions {
     ...
     */
    export const backgroundTheme = createAction<BackgroundTheme>(prefix('background_theme'));
     ...
     */
    export const setUsername = createAction<string>(prefix('set_username'));
}
