...
import {GAME_NAME, GameModel, GameToolType} from './game-model';
...
export namespace GameActions {
     ...
     * Use a game tool
     */
    export const useTool = createAction<GameToolType>(prefix('useTool'));
    
    /**
     * Save the current game state
     */
    export const saveGame = createAction(prefix('saveGame'));
    
    /**
     * Load a saved game state
     */
    export const loadGame = createAction(prefix('loadGame'));
    
    /**
     * Update tool availability based on score
     */
    export const updateTools = createAction(prefix('updateTools'));
}
